...
external open class Realm {
    constructor(config: Configuration? = definedExternally /* null */)
    ...
    open var schema: Array<ObjectSchema> = definedExternally
    open var schemaVersion: Number = definedExternally
    open var syncSession: Session? = definedExternally
    ...
    open fun <T> create(type: ObjectClass, properties: T /* T & Realm.ObjectPropsType */, update: Boolean? = definedExternally /* null */): T = definedExternally
    ...
    open fun delete(`object`: Object): Unit = definedExternally
    open fun delete(`object`: Array<Object>): Unit = definedExternally
    open fun delete(`object`: List<Any>): Unit = definedExternally
    open fun delete(`object`: Results<Any>): Unit = definedExternally
    ...
    open fun <T> objectForPrimaryKey(type: ObjectSchema, key: Number): T? = definedExternally
    open fun <T> objectForPrimaryKey(type: ObjectSchema, key: String): T? = definedExternally
    ...
    open fun <T> objects(type: String): Results<T> = definedExternally
    open fun <T> objects(type: ObjectSchema): Results<T> = definedExternally
    open fun <T> objects(type: Function<*>): Results<T> = definedExternally
